...
Route::controller(MainScreenController::class)->group(function(){
    ...
    Route::delete('admin/setting-main-page/main-screen/delete-picture' , 'removeImage');
});
...
Route::controller(PopularSpecialtyController::class)->group(function(){
    ...
    Route::get('/admin/setting-main-page/speciality-select' , 'selectSpecialities');
});

// текстовые блоки
Route::controller(TextBlockController::class)->group(function(){
    Route::get('/admin/setting-main-page/text-blocks/get', 'getBlocks');
    Route::post('/admin/setting-main-page/text-blocks/create', 'createBlock');
    Route::delete('/admin/setting-main-page/text-blocks/delete/{id}', 'deleteBlock');
    Route::delete('/admin/setting-main-page/text-blocks/delete-image/{id}', 'deleteImageBlock');
...
Route::controller(StuffController::class)->group(function(){
    ...
    Route::post('/admin/setting-main-page/stuff/subtitle/update', 'updateSubtitle');
    ...
    Route::delete('/admin/setting-main-page/stuff/delete-photo/{id}', 'deletePhotoStuff');
