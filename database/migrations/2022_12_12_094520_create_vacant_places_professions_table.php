...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('vacant_places_professions', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('course_id')->constrained();
            $table->unsignedBigInteger('profession_id')->constrained();
    ...
    {
        Schema::dropIfExists('vacant_places_professions');
    }
};
